...
class VisionMotoComplete:
    """Sistema completo VisionMoto com IoT e Visão Computacional"""
    ...
    def run_detection_demo(self, max_frames=100):
        ...
        while frame_count < max_frames:
            ...
            # Exibe frame
            cv2.imshow("VisionMoto - Sistema Completo", frame)
    ...
    def run_complete_demo(self):
        ...
        print("🎯 VisionMoto - Sistema Completo")
        print("=" * 50)
